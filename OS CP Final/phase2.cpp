    ...
    if (infile.is_open())
    {
      ...
      while (getline(infile, s))
      {
        if (s.rfind("$AMJ", 0) == 0)
        {
          ...
          // ✅ manual conversion instead of stoi
        ...
        else
        {
          ...
          cout << "Allocated page no. for prog card = " << pageNo << "\n";
          int length = s.size();
